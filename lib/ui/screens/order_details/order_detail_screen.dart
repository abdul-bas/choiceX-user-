                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        GestureDetector(
                          onTap: () async {
                            final snapshot = await UiDetailsGet()
                                .particularProductGet(widget.items.productId)
                                .first;
                            ...
                            pushScreen(
                              ...
                              ProductDetailPage(
                                product: product,
                                variantIndex: widget.items.variantIndex,
                              ),
                            );
                          },
                          child: ProductDetailCard(items: widget.items),
                        ),
                        const UserDetailsCard(),
                        PaymentCard(items: widget.items),
